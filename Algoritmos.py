...
def main():
    a = ler_arquivo()
    b = calcular_montante(a)
    c = calcular_total_gasto_por_empresa(a)
    d = politico_mais_recebeu(a, b)
    e = politico_menos_recebeu(a, b)
    f = empresa_mais_pagou(a, b)
    g = empresa_menos_pagou(a, b)
    h = media_propina_politico(a, b)
    i = media_propina_por_empresa(b)
    salvar_dados_em_arquivo(b, c, d, e, f, g, h, i)
